...
import { Lock, Mail, ArrowRight, Loader2, FileCheck2 } from "lucide-react"
      ...
      >
        <div className="p-8 pb-6 text-center border-b border-border/50 bg-muted/20">
          ...
          <p className="text-sm text-muted-foreground mt-2">
            {isLogin ? "Sign in to manage your paperwork" : "Create an account to get started"}
          </p>
        </div>
        ...
        <div className="p-8 pt-6 space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input 
                    ...
                    className="w-full h-11 pl-4 pr-4 rounded-xl border border-border bg-background text-sm focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all"
                  />
                </div>
              </div>
            )}
          ...
          <div className="grid grid-cols-2 gap-3">
            <button 
              ...
              disabled={isLoading}
              className="h-11 flex items-center justify-center gap-2 border border-border bg-card hover:bg-muted text-sm font-medium rounded-xl transition-all duration-200 active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:opacity-70"
            >
